...
function App() {
  ...
  useEffect(() => {
    if (userAdmin != null) {
      fetch(`/user_admins/${userAdmin.id}/villas/inquiries`)
        .then((r) => r.json())
        .then((data) => {
  ...
  useEffect(() => {
    if (userAdmin != null) {
      fetch(`/user_admins/${userAdmin.id}/villas`)
        .then((r) => r.json())
        .then((data) => {
    ...
    <BrowserRouter>
      <div className="App">
        ...
        <Routes>
          ...
          <Route
            ...
            element={
              <LocationVillaPage
                ...
                handleDeleteVilla={handleDeleteVilla}
                handleUpdateVilla={handleUpdateVilla}
                villas={villas}
          ...
          <Route
            path="/villas/:id"
            element={<VillaDetails addInquiryToVilla={addInquiryToVilla} />}
          />
          <Route
            path="/activities"
            element={<ActivityContainer activities={activities} />}
          />
          <Route
            path="/user_admin/:id/villas/inquieries"
            element={<IncomingInquiry />}
          />
          <Route
            path="/user_admin/villas"
            element={
              <ManageVillas
                villas={villas}
                userAdminVillas={userAdminVillas}
                setUserAdminVillas={setUserAdminVillas}
                handleDeleteVilla={handleDeleteVilla}
                handleUpdateVilla={handleUpdateVilla}
                locations={locations}
