class UserAdmin < ApplicationRecord
    ...
    #validates :first_name, :last_name, :email, :phone, :admin, presence: true
    ...
    #validates :phone, format: { with: /\A\d{3}-\d{3}-\d{4}\z/, message: "should be in the format xxx-xxx-xxxx" } # Validates presence and format of phone number using a regular expression
